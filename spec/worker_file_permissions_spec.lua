...
describe("worker file permissions", function()
  ...
  it("creates file with expected permissions", function()
    ...
    assert.same({
      ...
      "./letsencrypt/accounts/aHR0cHM6Ly9hY21lLXN0YWdpbmctdjAyLmFwaS5sZXRzZW5jcnlwdC5vcmcvZGlyZWN0b3J5Cg " .. server.nobody_user .. " " .. server.nobody_group .. " 700 d",
      "./letsencrypt/accounts/aHR0cHM6Ly9hY21lLXN0YWdpbmctdjAyLmFwaS5sZXRzZW5jcnlwdC5vcmcvZGlyZWN0b3J5Cg/account_id.json " .. server.nobody_user .. " " .. server.nobody_group .. " 600 f",
      "./letsencrypt/accounts/aHR0cHM6Ly9hY21lLXN0YWdpbmctdjAyLmFwaS5sZXRzZW5jcnlwdC5vcmcvZGlyZWN0b3J5Cg/account_key.pem " .. server.nobody_user .. " " .. server.nobody_group .. " 600 f",
      "./letsencrypt/accounts/aHR0cHM6Ly9hY21lLXN0YWdpbmctdjAyLmFwaS5sZXRzZW5jcnlwdC5vcmcvZGlyZWN0b3J5Cg/registration_info.json " .. server.nobody_user .. " " .. server.nobody_group .. " 600 f",
